...
<header class="space-y-4 p-5 sm:px-8 sm:py-6 lg:p-4 xl:px-8 xl:py-6">
    <div class="flex items-center justify-between">
        <a href="{{ route('pacientes.create') }}" class="hover:bg-blue-800 group flex items-center rounded-md bg-blue-700 text-white text-sm font-medium pl-2 pr-3 py-2 shadow-sm">
